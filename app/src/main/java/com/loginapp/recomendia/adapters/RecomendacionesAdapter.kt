...
class RecomendacionesAdapter(var recomendaciones: MutableList<Recomendacion>, var onClick: (Int) -> Unit): RecyclerView.Adapter<RecomendacionesAdapter.RecomendacionHolder>() {
